...
namespace WolfDen.Application.Requests.Commands.Attendence.Service
{
    public class DailyAttendancePollerService
    {
        ...
        public DailyAttendancePollerService(IOptions<OfficeDurationSettings> officeDurationSettings, IMediator mediator, ILogger<DailyAttendancePollerService> logger, IServiceScopeFactory serviceScopeFactory, ManagerIdFinder managerIdFinder)
        {
            _mediator = mediator;
            _logger = logger;
